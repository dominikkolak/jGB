...
public class UserInterface extends Application {
    ...
    private static final int[][] PALETTES = {
            { 0xFFE0F8D0, 0xFF88C070, 0xFF346856, 0xFF081820 },  // Classic Green
            { 0xFFFFFFFF, 0xFFAAAAAA, 0xFF555555, 0xFF000000 },  // Grayscale
            { 0xFF9BBC0F, 0xFF8BAC0F, 0xFF306230, 0xFF0F380F },  // Original DMG
            { 0xFFC4CFA1, 0xFF8B956D, 0xFF4D533C, 0xFF1F1F1F }   // Pocket
    };
    ...
    public void start(Stage primaryStage) {
        ...
        primaryStage.setTitle("JGBE - Java Game Boy Emulator");
    ...
    private MenuBar createMenuBar(Stage stage) {
        ...
        controlsItem.setOnAction(e -> showControls());
        MenuItem aboutItem = new MenuItem("About");
        aboutItem.setOnAction(e -> showAbout());
        helpMenu.getItems().addAll(controlsItem, aboutItem);

        menuBar.getMenus().addAll(fileMenu, emuMenu, viewMenu, helpMenu);
        return menuBar;
    }
    ...
    private void openRom(Stage stage) {
        ...
        if (file != null) {
            try {
                byte[] rom = CartridgeLoader.loadRom(file.getAbsolutePath());
    ...
    private void showAbout() {
        ...
        alert.setHeaderText("JGBE - Java Game Boy Emulator");
        alert.setContentText("A cycle-accurate Game Boy emulator written in Java.");
        alert.showAndWait();
    }
