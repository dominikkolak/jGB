...
/// seems to be working better with this cut down instruction set
...
public class OpcodeDecoder implements InstructionDecoder {
    ...
    private Instruction decodeStandardOpcode(int opcode, int pc, BUS bus) {
        switch (opcode) {
            ...
            // nop halt
            case 0x00: return MiscInstruction.nop();
            case 0x76: return MiscInstruction.halt();
            ...
            // SBC A, r
            case 0x9F: return ArithmeticInstruction.sbc(Register8.A);
            case 0x98: return ArithmeticInstruction.sbc(Register8.B);
            case 0x99: return ArithmeticInstruction.sbc(Register8.C);
            case 0x9A: return ArithmeticInstruction.sbc(Register8.D);
            case 0x9B: return ArithmeticInstruction.sbc(Register8.E);
            case 0x9C: return ArithmeticInstruction.sbc(Register8.H);
            case 0x9D: return ArithmeticInstruction.sbc(Register8.L);
            ...
            // JP nn unconditional
            case 0xC3:
                return new JumpInstruction(bus.readWord(pc + 1));

            // JP cc, nn conditional
            case 0xC2: return new JumpInstruction(bus.readWord(pc + 1), Condition.NZ);
            case 0xCA: return new JumpInstruction(bus.readWord(pc + 1), Condition.Z);
            case 0xD2: return new JumpInstruction(bus.readWord(pc + 1), Condition.NC);
            case 0xDA: return new JumpInstruction(bus.readWord(pc + 1), Condition.C);
